...
const RainingLetters: React.FC<RainingLettersProps> = ({ showTitle = true, asBackground = false }) => {
  ...
  return (
    <div
      className={
        asBackground
          ? "fixed inset-0 w-screen h-screen bg-black overflow-hidden pointer-events-none z-0"
